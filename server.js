...
io.sockets.on("connection", function (socket) {
  ...
  socket.on("new room", function (data, callback) {
    ...
    if (init) {
      ...
      // Host username
      io.sockets.adapter.rooms["room-" + socket.roomnum].hostName =
        socket.username;
    ...
    switch (io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer) {
      case 0:
        var currVideo =
          io.sockets.adapter.rooms["room-" + socket.roomnum].currVideo.yt;
        break;
      case 1:
        var currVideo =
          io.sockets.adapter.rooms["room-" + socket.roomnum].currVideo.dm;
        break;
      case 2:
        var currVideo =
          io.sockets.adapter.rooms["room-" + socket.roomnum].currVideo.vimeo;
        break;
      case 3:
        var currVideo =
          io.sockets.adapter.rooms["room-" + socket.roomnum].currVideo.html5;
        break;
      default:
  ...
  socket.on("play next", function (data, callback) {
    ...
    if (io.sockets.adapter.rooms["room-" + socket.roomnum] !== undefined) {
      switch (io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer) {
        case 0:
          if (
            io.sockets.adapter.rooms["room-" + socket.roomnum].queue.yt.length >
            0
          ) {
            // Gets the video id from the room object
            videoId = io.sockets.adapter.rooms[
              "room-" + socket.roomnum
            ].queue.yt.shift().videoId;
          }
          break;
        case 1:
          if (
            io.sockets.adapter.rooms["room-" + socket.roomnum].queue.dm.length >
            0
          ) {
            videoId = io.sockets.adapter.rooms[
              "room-" + socket.roomnum
            ].queue.dm.shift().videoId;
          }
          break;
        case 2:
          if (
  ...
  socket.on("remove at", function (data) {
    if (io.sockets.adapter.rooms["room-" + socket.roomnum] !== undefined) {
      ...
      switch (io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer) {
        case 0:
          io.sockets.adapter.rooms["room-" + socket.roomnum].queue.yt.splice(
            idx,
            1
          );
          break;
        case 1:
          io.sockets.adapter.rooms["room-" + socket.roomnum].queue.dm.splice(
            idx,
            1
          );
          break;
        case 2:
          io.sockets.adapter.rooms["room-" + socket.roomnum].queue.vimeo.splice(
            idx,
            1
          );
          break;
        case 3:
          io.sockets.adapter.rooms["room-" + socket.roomnum].queue.html5.splice(
            idx,
            1
          );
          break;
  ...
  socket.on("play at", function (data, callback) {
    if (io.sockets.adapter.rooms["room-" + socket.roomnum] !== undefined) {
      ...
      switch (io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer) {
        case 0:
          videoId =
            io.sockets.adapter.rooms["room-" + socket.roomnum].queue.yt[idx]
              .videoId;
          io.sockets.adapter.rooms["room-" + socket.roomnum].queue.yt.splice(
            idx,
            1
    ...
    if (io.sockets.adapter.rooms["room-" + socket.roomnum] !== undefined) {
      ...
      switch (io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer) {
        case 0:
          ...
          io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.yt.id =
            io.sockets.adapter.rooms["room-" + socket.roomnum].currVideo.yt;
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].prevVideo.yt.time = time;
          // Set new video id
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].currVideo.yt = videoId;
          break;
        case 1:
          // Set prev video before changing
          io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.dm.id =
            io.sockets.adapter.rooms["room-" + socket.roomnum].currVideo.dm;
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].prevVideo.dm.time = time;
          // Set new video id
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].currVideo.dm = videoId;
          break;
        case 2:
          // Set prev video before changing
          io.sockets.adapter.rooms[
          ...
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].prevVideo.vimeo.time = time;
          // Set new video id
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].currVideo.vimeo = videoId;
          break;
        case 3:
          // Set prev video before changing
          io.sockets.adapter.rooms[
          ...
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].prevVideo.html5.time = time;
          // Set new video id
          io.sockets.adapter.rooms[
            "room-" + socket.roomnum
          ].currVideo.html5 = videoId;
          break;
        default:
          console.log("Error invalid player id");
      }
  ...
  socket.on("change previous video", function (data, callback) {
    if (io.sockets.adapter.rooms["room-" + socket.roomnum] !== undefined) {
      ...
      switch (io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer) {
        case 0:
          var videoId =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.yt.id;
          var time =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.yt
              .time;
          break;
        case 1:
          var videoId =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.dm.id;
          var time =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.dm
              .time;
          break;
        case 2:
          var videoId =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.vimeo
              .id;
          var time =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.vimeo
              .time;
        ...
        case 3:
          var videoId =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.html5
              .id;
          var time =
            io.sockets.adapter.rooms["room-" + socket.roomnum].prevVideo.html5
              .time;
      ...
      console.log(
        "Hot Swapping to Previous Video: " +
          videoId +
          " at current time: " +
          time
      );
  ...
  function updateQueueVideos() {
    if (io.sockets.adapter.rooms["room-" + socket.roomnum] !== undefined) {
      ...
      var currPlayer =
        io.sockets.adapter.rooms["room-" + socket.roomnum].currPlayer;
